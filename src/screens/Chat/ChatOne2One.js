    ...
    API.graphql(
      graphqlOperation(listChats, {
        filter: {
          ...
          // ownerFullname: {contains: 'Tu khoa can tim'}, // TODO used for search
        },
        // limit: 4, // paging
    ...
    const response = await API.graphql(
      graphqlOperation(createChat, {
        input: {
          ...
          participantUserIds: ['created-user-id', 'participant-user-id'], // TODO fill user id would like to chat
          imageUrls: [
